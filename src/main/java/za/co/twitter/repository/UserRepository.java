...
public class UserRepository {
	...
	private void readUserRepository() throws IOException {
        try (Stream<String> userNames = Files.lines(Paths.get(TwitterMainAppController.userFileName))) {
        	System.out.println("<!-----Read all user lines as a Stream-----!>");
        	userNames.forEach(System.out :: println);
        	userNames.close();
        } catch (IOException e) {
            //when this repository fails, throw the error back to caller
            throw e;
        }
    }
